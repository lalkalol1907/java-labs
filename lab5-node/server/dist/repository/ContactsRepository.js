...
class ContactsRepository {
    ...
    createContact(contact) {
        return __awaiter(this, void 0, void 0, function* () {
            console.log(contact);
            const res = yield this._collection.insertOne(contact);
            return Object.assign({ _id: res.insertedId }, contact);
        });
    }
    updateContact(id, contact) {
        return __awaiter(this, void 0, void 0, function* () {
            const _id = new mongoDB.ObjectId(id);
            yield this._collection.updateOne({ _id }, contact);
        });
    }
    deleteContactById(id) {
        return __awaiter(this, void 0, void 0, function* () {
            const _id = new mongoDB.ObjectId(id);
            yield this._collection.deleteOne({ _id });
        });
    }
}
